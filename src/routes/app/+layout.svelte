            ...
            <div class="flex">
                ...
                <div class="flex-1 group">
                    <a 
                        ...
                        class={(currentPage === "notifications" ? "text-[#F06346] border-[#F06346] " : "group-hover:text-[#F06346] group-hover:border-[#F06346] text-gray-400 ") + "flex items-end justify-center text-center mx-auto px-4 pt-2 w-full border-b-2 border-transparent"}>
                        <span class="block px-1 pt-1 pb-2">
