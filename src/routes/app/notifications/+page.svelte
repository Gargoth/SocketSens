<script>
  ...
  // TODO: Update notificationStore with latest notifications from Database
</script>
	...
	<div class="notifcol flex flex-col-reverse pl-4 pt-6 pr-4">
		{#each $notificationHistory as notif}
			<div class="notifs flex items-center">
				<div
					class={'iconbox rounded-full p-1 ml-4 mb-16 ' +
						(notif.type === 'softlimit' ? 'bg-[#F06346]' : 'bg-[#F04646]')}
				>
